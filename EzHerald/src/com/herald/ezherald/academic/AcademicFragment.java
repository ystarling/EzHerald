...
public class AcademicFragment extends SherlockFragment implements ActionBar.OnNavigationListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
	{
		...
		// 数据获取，暂且直接给出
		JwcInfo [] jwcArr = {new JwcInfo("[教务管理]","四六级考试","2013-6-15","四六级考试将在九龙湖校区进行，请各位同学做好准备"),
				new JwcInfo("[教务管理]","期末考试","2013-6-17","期末考试记录说明：这学期学校继续严厉打击作弊行为...")};
		// 设置listView的adapter
        ...
        foot.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				...
				try {
					...
					new RequestJwcInfo().execute(new URL("http://jwc.seu.edu.cn"));
				} catch (MalformedURLException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
		...
		listView.setOnItemClickListener(new OnItemClickListener(){
			...
			public void onItemClick(AdapterView<?> parent, View view, int position,
					long id) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(getActivity(),AcademicDetailActivity.class);
			...
			try {
				...
				else
				{
					...
					if ( response == HttpURLConnection.HTTP_OK )
					{
						...
						list.add(new JwcInfo("[生活提醒]","紧急天气预警","2013-6-23","南京蛋疼的天气又来雨了，估计周三才能停，童鞋们忍一忍吧。"));
						list.add(new JwcInfo("[生活提醒]","暑期放假通知","2013-6-25","又要放假了，小心被子发霉啊，该咋办问爹妈吧。"));
						return list;
					}
				}
			} catch (IOException e) {
