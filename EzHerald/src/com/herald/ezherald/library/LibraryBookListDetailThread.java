...
public class LibraryBookListDetailThread extends Thread {
	...
	public void run() {
		...
		try {
			...
			try {
				...
				// BasicNameValuePair("book_callNumber",bundle.getString("loc_callNumber"));
				// list.add(pair1);
	...
	class MyHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			...
			String subject_topic = null, vector = null, clc = null;
			String personal_responsible = null, other_titles = null;
			...
			try {
				...
				personal_responsible = json_detail.getString("个人责任者:")
						.toString();
		...
		public void SetRemind() {
			Toast toast1 = Toast
					.makeText(activity, "网络故障!", Toast.LENGTH_SHORT);
			toast1.show();
		}
	...
	public class bookDetailAdapter extends BaseAdapter {
		...
		public bookDetailAdapter(Context c, JSONObject mjson)
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				convertView = inflater.inflate(
						R.layout.library_book_listview_b, null);
				holder = new ViewHolder();

				holder.text1 = (TextView) convertView
						.findViewById(R.id.libr_book_suoshuhao);
				holder.text2 = (TextView) convertView
						.findViewById(R.id.libr_book_barcode);
				holder.text3 = (TextView) convertView
						.findViewById(R.id.libr_book_year_title);
				holder.text4 = (TextView) convertView
						.findViewById(R.id.libr_book_campus);
				holder.text5 = (TextView) convertView
						.findViewById(R.id.libr_book_collection);
				holder.text6 = (TextView) convertView
						.findViewById(R.id.libr_book_status);
